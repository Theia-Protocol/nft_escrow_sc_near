...
pub struct MultiToken {
    ...
    pub balances_per_token: Option<LookupMap<TokenId, HashMap<AccountId, u64>>>,
...
impl MultiToken {
    ...
    pub fn internal_mint_with_refund(
        ...
        let token_id = self.all_total_supply.to_string();
        self.all_total_supply = self.all_total_supply.checked_add(1).unwrap();
